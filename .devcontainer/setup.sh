...
sdkmanager "platform-tools" "emulator" "system-images;android-29;default;x86_64"

echo ">>> Creating AVD..."
avdmanager create avd -n "test_avd" -k "system-images;android-29;default;x86_64" --force
